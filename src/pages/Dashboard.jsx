...
export default function Dashboard() {
  ...
  const [stats, setStats]         = useState({ totalBudget: 0, totalSpent: 0, remaining: 0, memberCount: 0 })
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setStats({ totalBudget, totalSpent, remaining: totalBudget - totalSpent, memberCount: memberCount ?? 0 })
      setOverview(
        (topAccounts ?? []).map((a) => ({
          id:    a.id,
